...
5.  From your branch, make a pull request against `DSACMS/graphics/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `DSACMS/graphics/main`
...
graphics will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
graphics uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/DSACMS/graphics/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of graphics. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of graphics:
...
[proj-releases-new]: https://github.com/DSACMS/graphics/releases/new
-->
...
docs. Please file an [issue](DSACMS/graphics/issues).
-->
